...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.98\linewidth]{figures_9_20260922/fig09_software_gui_real_runtime.png}
\bicaption{数字孪生软件运行态界面示例}{Runtime interface example of the digital-twin software}
